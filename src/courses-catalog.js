export const courses = [
	...
	},
	{
		...
		shortDescription: 'ארבעה מפגשים על עמידות ידיים.',
		tags: ['תנועה', 'ספורט', 'איזון'],
		teacher: {
			name: 'נועה ברקאי',
			bio: 'מאמנת תנועה ומורה ליוגה עם ניסיון של 12 שנים בלימוד ותרגול עמידות ידיים.',
			image: 'https://source.unsplash.com/600x300/?yoga',
		},
		price: '₪300',
		duration: 4,
		...
		image: 'https://images.unsplash.com/photo-1521804630986-6e83bf04d897?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGhhbmQlMjBzdGFuZHxlbnwwfHwwfHx8MA%3D%3D',
	},
	{
		id: '3fbb9a7d-77f6-44e4-b748-5bf1f4cb82d2',
		title: 'סדנת כתיבת שירה',
		description: 'חמישה מפגשים בהם נחקור את סודות השירה, נלמד טכניקות כתיבה שונות ונעמיק בסגנונות מגוונים, תוך עידוד יצירה אישית.',
		shortDescription: 'סדנת כתיבה יוצרת המתמקדת בשירה.',
		tags: ['כתיבה', 'שירה', 'יצירה'],
		teacher: {
			name: 'יונתן שדה',
			bio: 'משורר, עורך ומנחה סדנאות כתיבה, מחבר הספר "קווים שבורים".',
			image: 'https://source.unsplash.com/600x300/?writer',
		},
		price: '₪400',
		duration: 5,
	...
	},
	{
		...
		title: 'קבוצת שחייה בים חוף ירושלים',
		description: 'מפגשים שבועיים לשחייה משותפת בים הפתוח, עם דגש על שיפור סגנון, כושר ושחייה בקבוצה.',
		shortDescription: 'שחייה חופשית בקבוצה בים הפתוח.',
		tags: ['ספורט', 'שחייה', 'ים'],
		teacher: {
			name: 'יואב מזרחי',
			bio: 'מאמן שחייה מוסמך ומדריך מים פתוחים עם ניסיון של 15 שנה.',
			image: 'https://source.unsplash.com/600x300/?swimmer',
		},
		price: 'חינם',
		duration: 8,
	...
	},
	{
		...
		shortDescription: 'דיון מעמיק ביצירת המופת של טולסטוי.',
		tags: ['ספרות', 'קריאה', 'פילוסופיה'],
		teacher: {
			name: 'רועי פרידמן',
			bio: 'מרצה לספרות רוסית ומבקר ספרות עם תשוקה מיוחדת לטולסטוי ודוסטויבסקי.',
			image: 'https://source.unsplash.com/600x300/?books',
		},
		price: '₪280',
		duration: 6,
	...
	},
	{
		...
		shortDescription: 'מבוא להתנהלות כלכלית נבונה.',
